...
public class RNShopifyModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void webCheckout(ReadableArray cartItems, String email, ReadableMap addressDictionary, final Promise promise) {
        Cart cart;
        ...
        if (checkout != null) {
            ...
            //checkout.setWebReturnToUrl("bobsweep://home");
